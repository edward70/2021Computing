...
for i in range(60): # grass spots
    pygame.draw.circle(screen, DARK_GREEN, [randint(0,480),randint(270,480)], 5)
...
for i in range(1,6): # cloud generation (proud of this one :)
    ...
    d = randint(20,30)
    for j in range(10):
        pygame.draw.ellipse(screen, WHITE, [a+randint(-20,20),b+randint(-20,20),c+randint(-20,20),d]) # clouds

pygame.draw.rect(screen, BLUE, [100,400,100,50]) # car
pygame.draw.ellipse(screen, GREY, [180,450,20,20]) # wheel
pygame.draw.ellipse(screen, GREY, [100,450,20,20]) # wheel
pygame.draw.rect(screen, CYAN, [170,400,30,25]) # window
pygame.draw.rect(screen, BLACK, [100,400,20,25]) # remove edge
pygame.draw.rect(screen, BLACK, [190,400,10,25]) # remove edge
